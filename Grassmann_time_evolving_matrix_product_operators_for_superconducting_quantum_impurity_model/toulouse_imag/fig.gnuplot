...
set key bottom Left reverse offset 3,0.3
plot "ed_uu.dat" u 1:2 w l ls 1 t '\small{ED}',\
     "uu.dat" u 1:2 w l ls 2 dt 2 t '$\scriptstyle\chi=250,\delta\tau=0.05$'
...
set xlabel '$\delta\tau$'
set ylabel '$\mathcal{E}$' offset 2.5,0
set label '$\scriptstyle{\times10^{-4}}$' at graph 0,1.04
plot "ud_dt.dat" u 1:($2*1e4) w lp ls 2 dt 2 pt 4 ps 1.5 notitle,\
...
plot "uu_chi.dat" u 1:($2*1e3) w lp ls 2 dt 2 pt 4 ps 1.5 notitle
...
set label '$\scriptstyle{\times10^{-2}}$' at graph 0,1.04
plot "ud_chi.dat" u 1:($2*1e2) w lp ls 2 dt 2 pt 4 ps 1.5 notitle,\
